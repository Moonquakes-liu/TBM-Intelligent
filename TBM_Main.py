...
print(' ->->', '\033[0;33m请将本程序及其附属模块均放置在要提取的文件夹上一级目录下，如要提取数据的文件夹在{···/RawDataSet}，则程序文件放置在{···/}下！！！\033[0m')
...
TBM_CYCLE().read_file(Raw_Data_Input, Cycle_Data_Output, Par_name, 100)  # 循环段分割
